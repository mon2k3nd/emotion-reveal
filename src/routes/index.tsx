...
function WeddingHero({ intro = false, showHint = false, entering = false }: { intro?: boolean; showHint?: boolean; entering?: boolean }) {
  return <section id={intro ? undefined : "home"} className="wedding-hero-frame relative min-h-[100svh] overflow-hidden bg-foreground">
    ...
    <div className={`hero-copy relative mx-auto flex min-h-[100svh] max-w-5xl flex-col items-center justify-end px-5 pb-12 text-center text-primary-foreground ${entering ? "is-entering" : ""}`}>
